...
const Experience = () => (
  <div>
    <p className="experienceTitre">Expériences professionnelles</p>
    <p className="experienceSousTitre">L'expertise fonctionnelle au service du développement web</p>
    {/* O'CLOCK */}
    <div className="acticle">
      ...
      <p className="t5">FORMATION DÉVELOPPEUR FULLSTACK JavaScript</p>
      <div className="liste">
        <p className="liste__titre">Spécialisation Réact / Rédux</p>
      </div>
      <p className="t6">
    ...
    <div className="acticle">
      <div className="periode">
        ...
        <div className="periode_date">11/2016</div>
      </div>
      ...
      <p className="t5">Co-gérance de la société</p>
    </div>
    <p className="t6">
    ...
    <div className="acticle">
      ...
      <p className="t6"><span className="t4">SOUS-TRAITANT DU GROUPE BERGER-LEVRAULT - FREELANCE - ANGOULÊME</span></p>
    </div>
